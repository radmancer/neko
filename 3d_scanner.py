...
def cloudInit(rotateAngle):
    ...
    img.save(output_directory + str(rotateAngle + 1) + ".png")
    img2 = Image.open(output_directory + str(rotateAngle + 1) + ".png")
...
def writeToFile():
    #File object
    filename = script_directory + "create_object.py"
    ...
    FILE.writelines('"""')
    FILE.writelines('\n')
    FILE.writelines("Name: 'create_object'")
    FILE.writelines('\n')
